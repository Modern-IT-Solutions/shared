...
// import '../../../../temp_core.dart';
// import '../../data/repositories/repository.dart';
// import 'create.dart';
// import 'find.dart';
// import 'update.dart';

// /// [ManageView] is a tab for depositRequests
// class ManageView<T extends Model> extends ModelMnanagerView<T> {
//   @override
//   final RepositoryInterface<T> repository;

//   final Map<String, QueryFilter<T>> filters;
//   final List<String> features;
//   ManageView({
//     super.key,
//     this.filters = const {},
//     this.features = allfeatures,
//   }) : repository = DepositRequestRepository.instance as CFLUDInterface<T>;
...
//   @override
//   State<ManageView> createState() => ManageDepositRequestsViewState<T>();
// }

// class ManageDepositRequestsViewState<T extends Model> extends State<ManageView> with ModelMnanagerViewMixin<DepositRequestModel> {
//   Map<String, QueryFilter<T>> filters = {};
...
//           filters[filter] = filters[filter]!.copyWith(active: false);
//         }
//       },
//       fixed: true,
//     );
...
//                         onTap: () {
//                           setState(() {
//                             filters[filter.name] = filter.copyWith(active: !filter.active);
