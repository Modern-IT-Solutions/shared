...
// /// [CreateDepositRequestForm] is a form to create a new user
// class CreateDepositRequestForm extends StatefulWidget {
//   final VoidCallback? onCancel;
//   final Null Function(DepositRequestModel depositRequest)? onCreated;
//   const CreateDepositRequestForm({
//     Key? key,
//     this.onCreated,
//     this.onCancel,
//   }) : super(key: key);
...
//   @override
//   State<CreateDepositRequestForm> createState() => _CreateDepositRequestFormState();
// }

// class _CreateDepositRequestFormState extends State<CreateDepositRequestForm> {
...
//         _loading = true;
//       });
//       var id = FirebaseFirestore.instance.collection('depositRequests').doc().id;
//       var createRequest = DepositRequestCreateRequest(
//         id: id,
...
//       try {
//         widget.onCreated
//             ?.call(await DepositRequestRepository.instance.create(createRequest));
//       }
...
//                           ),
//                         ),
//                         title: const Text('Create DepositRequest'),
...
//                               title: Text("DepositRequest Information"),
//                               enabled: false,
//                             ),
